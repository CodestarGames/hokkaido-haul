...
export default class LevelTemplate_0_6Prefab extends LevelTemplatePrefabBase {
	...
	constructor(scene: Phaser.Scene, x?: number, y?: number) {
		...
		// enemyDroneInst
		const enemyDroneInst = new enemyDrone(scene, 442, 225);
		...
		// enemyDroneInst_1
		const enemyDroneInst_1 = new enemyDrone(scene, 723, 221);
