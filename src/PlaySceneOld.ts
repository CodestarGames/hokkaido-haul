...
class PlaySceneOld extends Phaser.Scene {
    ...
    create() {
        ...
        this.startTrigger = this.physics.add.sprite(0, 10, null, null).setOrigin(0, 1).setImmovable();
        this.ground = this.add.tileSprite(0, height, 88, 26, 'ground').setOrigin(0, 1)
        this.dino = this.physics.add.sprite(0, height, 'van-idle', 1)
        ...
        this.physics.add.overlap(this.startTrigger, this.dino, () => {
            ...
            const startEvent =  this.time.addEvent({
                ...
                callback: () => {
                    ...
                    this.dino.play('anim-van-idle', true);
    ...
    handleInputs() {
        ...
        this.input.keyboard.on('keydown-SPACE', () => {
            ...
            if (!(this.dino.body as Phaser.Physics.Arcade.Body).onFloor() || this.dino.body.velocity.x > 0) { return; }

            this.jumpSound.play();
            this.dino.body.setSize(this.dino.body.width, 92);
            this.dino.body.offset.y = 0;
            this.dino.setVelocityY(-1600);
            this.dino.setTexture('van-idle', 0);
        })

        this.input.keyboard.on('keydown-DOWN', () => {
            if (!(this.dino.body as Phaser.Physics.Arcade.Body).onFloor() || !this.isGameRunning) { return; }
    ...
    update(time, delta) {
        ...
        this.obsticles.getChildren().forEach((obstacle:any) => {
        ...
        if (this.dino.body.deltaAbsY() > 0) {
            ...
            this.dino.body.height <= 58 ? this.dino.play('dino-down-anim', true) : this.dino.play('anim-van-idle', true);
        }
    }
}

export default PlaySceneOld;
